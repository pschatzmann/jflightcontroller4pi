...
public class PIDController {
	 ...
	 * This has two primary effects: Adds a "startup kick" and speeds up system
	 * response during setpoint changes Adds "drag" and slows the system when moving
	 * toward the target A small D value can be useful for both improving response
	 * times, and preventing overshoot. However, in many systems a large D value
	 * will cause significant instability, particularly for large setpoint changes.
	 * <br>
	...
	/**
	 * Determines the error between the actual value and the setpoint
	 * 
	 * @return
	 */
	public double getError() {
		return this.lastActual - this.setpoint;
	}
}
