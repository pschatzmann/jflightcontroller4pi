...
public class AutoPilot implements IOutDevice {
	private static Logger log = LoggerFactory.getLogger(AutoPilot.class);
	...
	public void shutdown() {
		log.info("shutdown");
		this.flightController.setAutoPilot(null);
		flightPlan.clear();
		direction = 0;
		angle = 0;
		speed = 0;
