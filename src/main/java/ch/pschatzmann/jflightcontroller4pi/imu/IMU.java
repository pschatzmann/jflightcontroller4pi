...
/**
 * Determine the Pitch, Yaw, Roll and Heading with the help of a gyro,
...
public class IMU implements IIMU {
	...
	private volatile float beta = betaDef; // 2 * proportional gain (Kp)
	private volatile float q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f; // quaternion of sensor frame relative to
	 ...
	 * http://en.wikipedia.org/wiki/Fast_inverse_square_root See:
